		...
		<div class="faq">
			...
			<div class="faq_answer_container">
				<div class="faq_answer">
					<hr />
					<br /> 네 맞습니다. Table Ware의 공급사는 현지 유통 채널을 통해 조달되는 100% 정품입니다. 이에 더해
					Table Ware는 제품 공급에 불필요한 유통구조를 줄이고 좋은 제품을 합리적인 가격에 판매해 왔습니다. 따라서 믿고
					구매하셔도 좋습니다.<br />
					<br />
					<hr />
				</div>
		...
		<div class="faq">
			...
			<div class="faq_answer_container">
				<div class="faq_answer">
					...
					특정 제품에 대한 더 자세한 정보가 필요하신 분은 고객 센터로 문의 주시기 바랍니다.<br />
					<br />
					<hr />
				</div>
			</div>
		...
		<div class="faq">
			...
			<div class="faq_answer_container">
				<div class="faq_answer">
					...
					아래 고객센터로 연락해주시면 최대한 신속히 도와드립니다.<br />
					<br />
					<hr />
				</div>
			</div>
