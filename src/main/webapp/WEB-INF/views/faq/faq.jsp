...
<body>
	...
	<div class="box">
		...
		<div class="faq_container">
			<div class="faq">
				<div class="faq_question"><br/>★(상품/AS) 판매되는 제품에 어떤 품질 보장이 적용되나요?<br/></div>
		...
		<div class="faq_container">
			<div class="faq">
				<div class="faq_question"><br/>★(배송/통관) 배송 방법 및 방법에 따른 비용과 예상 소요
					시간이 궁금합니다.<br/></div>
				<div class="faq_answer_container">
					<div class="faq_answer">
						<hr />
		...
		<div class="faq_container">
			<div class="faq">
				<div class="faq_question"><br/>★(주문/결제) 주문 취소가 가능한가요? 주문 취소는 어떻게
					하나요?<br/></div>
				<div class="faq_answer_container">
					<div class="faq_answer">
						<hr />
		...
		<div class="faq_container">
			<div class="faq">
				<div class="faq_question"><br/>★입력하려는 도로명 주소가 너무 길어 주소란에 다 안 들어간다면?<br/></div>
				<div class="faq_answer_container">
					<div class="faq_answer">
						<hr />
		...
		<div class="faq_container">
			<div class="faq">
				<div class="faq_question"><br/>★(상품/AS) 제품이 파손되어 배송되었습니다. / 상품에 하자가
					있습니다. 어떻게 해야 하나요?<br/></div>
				<div class="faq_answer_container">
					<div class="faq_answer">
						<hr />
